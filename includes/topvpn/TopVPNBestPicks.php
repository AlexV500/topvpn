...
class TopVPNBestPicks extends PublicList{
        ...
        $output .= '<div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="tt-section-heading text-center mt-4 mb-5">
                    <h2 class=""> '. goTranslate("Our VPN Picks for 2023") .'</h2>
                    <p class="tt-section-subhead">The best VPN services are presented here for various evaluation criteria</p>
                    <div class="popup" onclick="togglePopup(\'disclaimerPopup\')">'. goTranslate("Advertiser Disclosure") .'
  <span class="popuptext" id="disclaimerPopup">'. goTranslate("To keep Top10VPN a free online resource, we receive advertising/referral fees when you buy a VPN through outlinks on this page. This impacts the score, location, prominence and order in which a VPN service appears. Our extensive tests of each VPN, and how it compares with other VPNs in different countries and/or for specific purposes, are also factored in. We do not feature every VPN product on the market. Listings on this page do not imply endorsement. To learn more, see") .'</span>
        ...
        /*---------*/ $output .= '<h5>'. goTranslate("Best VPN by") .' <span style="'.$colorStyleH5.'">'. goTranslate("Average Rating") .'</span></h5>';
        /*---------*/ // $output .= '<a class="tt-read-more" href="' . $this->bestVPN['rating'][0]['vpn_sys_name'] .'">Go To Review <i class="fa fa-arrow-right"></i></a>';
        /*---------*/ $output .= '<a class="btn btn-warning btn-xsm" href="' . $this->bestVPN['rating'][0]['vpn_sys_name'] .'" role="button">'. goTranslate("View more...") .'</a>&nbsp';
        ...
        /*---------*/ $output .= '<h5>'. goTranslate("Best VPN by") .' <span style="'.$colorStyleH5.'">'. goTranslate("Overall Speed") .'</span></h5>';
        /*---------*/ // $output .= '<a class="tt-read-more" href="' . $this->bestVPN['user_score'][0]['vpn_sys_name'] .'">Go To Review <i class="fa fa-arrow-right"></i></a>';
        /*---------*/ $output .= '<a class="btn btn-warning btn-xsm" href="' . $this->bestVPN['overall_speed'][0]['vpn_sys_name'] .'" role="button">'. goTranslate("View more...") .'</a>&nbsp';
        /*---------*/ $output .= '<a class="btn btn-tertiary btn-xsm" href="" role="button">Visit site</a>';
        /*------*/$output .= '</div>';
        /*---*/$output .= '</div>';
        ...
        /*---------*/ $output .= '<h5>'. goTranslate("Best VPN by") .' <span style="'.$colorStyleH5.'">'. goTranslate("Feature Score") .'</span></h5>';
        /*---------*/ // $output .= '<a class="tt-read-more" href="' . $this->bestVPN['feautures_score'][0]['vpn_sys_name'] .'">Go To Review <i class="fa fa-arrow-right"></i></a>';
        /*---------*/ $output .= '<a class="btn btn-warning btn-xsm" href="' . $this->bestVPN['feautures_score'][0]['vpn_sys_name'] .'" role="button">'. goTranslate("View more...") .'</a>&nbsp';
        /*---------*/ $output .= '<a class="btn btn-tertiary btn-xsm" href="" role="button">Visit site</a>';
        /*------*/$output .= '</div>';
        /*---*/$output .= '</div>';
        ...
        /*---------*/ $output .= '<h5>'. goTranslate("Best VPN by") .' <span style="'.$colorStyleH5.'">'. goTranslate("Privacy Score") .'</span></h5>';
        /*---------*/ // $output .= '<a class="tt-read-more" href="' . $this->bestVPN['privacy_score'][0]['vpn_sys_name'] .'">Go To Review <i class="fa fa-arrow-right"></i></a>';
        /*---------*/ $output .= '<a class="btn btn-warning btn-xsm" href="' . $this->bestVPN['privacy_score'][0]['vpn_sys_name'] .'" role="button">'. goTranslate("View more...") .'</a>&nbsp';
        /*---------*/ $output .= '<a class="btn btn-tertiary btn-xsm" href="" role="button">Visit site</a>';
        /*------*/$output .= '</div>';
        /*---*/$output .= '</div>';
        ...
        /*---------*/ $output .= '<h5>'. goTranslate("Best VPN by") .' <span style="'.$colorStyleH5.'">'. goTranslate("Value For Money") .'</span></h5>';
        ...
        /*---------*/ $output .= '<a class="btn btn-warning btn-xsm" href="' . $this->bestVPN['value_for_money_score'][0]['vpn_sys_name'] .'" role="button">'. goTranslate("View more...") .'</a>&nbsp';
        /*---------*/ $output .= '<a class="btn btn-tertiary btn-xsm" href="" role="button">Visit site</a>';
        /*------*/$output .= '</div>';
        /*---*/$output .= '</div>';
        ...
        /*---------*/ $output .= '<h5>'. goTranslate("Best VPN by") .' <span style="'.$colorStyleH5.'">'. goTranslate("Streaming Rate") .'</span></h5>';
        /*---------*/ // $output .= '<a class="tt-read-more" href="' . $this->bestVPN['user_score'][0]['vpn_sys_name'] .'">Go To Review <i class="fa fa-arrow-right"></i></a>';
        /*---------*/ $output .= '<a class="btn btn-warning btn-xsm" href="' . $this->bestVPN['streaming_rate'][0]['vpn_sys_name'] .'" role="button">'. goTranslate("View more...") .'</a>&nbsp';
        /*---------*/ $output .= '<a class="btn btn-tertiary btn-xsm" href="" role="button">Visit site</a>';
        /*------*/$output .= '</div>';
        /*---*/$output .= '</div>';
        ...
        /*---------*/ $output .= '<h5>'. goTranslate("Best VPN by") .' <span style="'.$colorStyleH5.'">'. goTranslate("Torrenting Rate") .'</span></h5>';
        /*---------*/ // $output .= '<a class="tt-read-more" href="' . $this->bestVPN['user_score'][0]['vpn_sys_name'] .'">Go To Review <i class="fa fa-arrow-right"></i></a>';
        /*---------*/ $output .= '<a class="btn btn-warning btn-xsm" href="' . $this->bestVPN['torrenting_rate'][0]['vpn_sys_name'] .'" role="button">'. goTranslate("View more...") .'</a>&nbsp';
        /*---------*/ $output .= '<a class="btn btn-tertiary btn-xsm" href="" role="button">Visit site</a>';
        /*------*/$output .= '</div>';
        /*---*/$output .= '</div>';
        ...
        /*---------*/ $output .= '<h5>'. goTranslate("Best VPN by") .' <span style="'.$colorStyleH5.'">'. goTranslate("Gaming Rate") .'</span></h5>';
        /*---------*/ // $output .= '<a class="tt-read-more" href="' . $this->bestVPN['user_score'][0]['vpn_sys_name'] .'">Go To Review <i class="fa fa-arrow-right"></i></a>';
        /*---------*/ $output .= '<a class="btn btn-warning btn-xsm" href="' . $this->bestVPN['gaming_rate'][0]['vpn_sys_name'] .'" role="button">'. goTranslate("View more...") .'</a>&nbsp';
        /*---------*/ $output .= '<a class="btn btn-tertiary btn-xsm" href="" role="button">Visit site</a>';
        /*------*/$output .= '</div>';
        /*---*/$output .= '</div>';
        ...
        $output .= '<div id="" class="">
                ...
                <div class="text-center">
                    ...
                    '. goTranslate("View All VPNs Comparison") .' <i class="fa fa-arrow-right"></i>
                    </a>
                </div>
            </div>
            </div>
