...
//        }
        ...
        $output .= '<p>'. goTranslate("Performance Ratings:") .'</p>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Overall Speed:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("A higher-speed VPN enables you to stream 4k content with no lag and also to download large files quickly.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Torrenting:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("Most VPNs allow torrenting using a BitTorrent client. We’ve ranked VPN services according to their torrenting privacy features.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Streaming:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("VPN services enable you to watch content from major streaming platforms privately and securely.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';
        ...
        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Server Locations:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("The physical location of your server is an essential factor in determining your website loading speed. If your servers are located far away, it will cause a delay in data transfer. As a result, your users will witness site latency.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Easy to Use:") .' </p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("Not all VPN services are equal in terms of ease of use. We’re ranked our VPN partners based on how streamlined the interface and features are.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';
  ...
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
        ...
        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Data Cap:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("Unfortunately, using a VPN to get online doesn\'t mean you can forget about data caps. Browsing the internet, listening to music, downloading videos, and streaming movies will still count against any data limits set by your providers, whether you\'re using a VPN or not.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("IP Adresses:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("A VPN replaces your actual IP address to make it look like you\'ve connected to the internet from a different location: the physical location of the VPN server, rather than your real location. This is just one reason why so many people use VPNs.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Speed:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("All VPNs establish an encrypted tunnel over your existing Internet connection, which means the main factor that determines the speed of your VPN connection is the base speed of your Internet connection. Other factors that might limit VPN speeds include: The speed of the connection from your Internet service provider.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Data Leaks:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("Even though all VPNs are developed for the purpose of providing safe and private connections, not all of them are created equal; in some cases, buggy VPNs can leak data such as internet protocol (IP) addresses and even facilitate certain types of cybercrime.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Logging Policy:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("A VPN provider\'s log-keeping policy is its official stance on data retention. It sets the bar for what you, the customer, can expect when using its services.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Jurisdiction:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("Your ability to access a VPN in your country is determined by the laws and regulations enacted by your government. Each country can allow or ban the use of VPNs and your only real recourse would be to move to a more privacy-friendly country.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Simultaneous Connections:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("In the case of VPNs, simultaneous connections are when you have more than one device active (the connection) in your VPN subscription at the same time (that\'s the “simultaneous” part). The more of these that your provider allows, the more connections you can have open at the same time.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("No. of Servers:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("The more servers a VPN has, the faster the browsing is. A VPN connects you to optimal servers so you can enjoy faster and safer connections.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Countries:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("A large number of supported countries translates to a better experience when connecting to servers from all over the world.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Works In China:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("Best vpn\'s for China") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';
        ...
        if (count($this->addKeys) > 0) {
            $output .= '<div class="entry table_category">';
            $output .= '<p>'. goTranslate("Additional Data:") .'</p>';
            $output .= '</div>';
  ...
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
        ...
        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Support:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("Sometimes, you may have questions or issues with a VPN provider. Excellent customer support makes top VPNs stand out.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';

        $output .= '<div class="entry">';
        $output .= '<p>'. goTranslate("Money Back:") .'</p>';
        $output .= '&nbsp<span class="" data-toggle="tooltip" data-placement="top" title="'. goTranslate("If your experience with a VPN service wasn’t to your liking, don’t worry. For a period of usually 30 days, you can ask for a refund.") .'"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
</svg></span>';
        $output .= '</div>';
